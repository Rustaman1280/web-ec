  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
        ...
        <Link href="/member/games" className="glass-panel" style={{ padding: '2rem 1rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', textDecoration: 'none', color: 'inherit' }}>
           <i className="ti ti-device-gamepad-2" style={{ fontSize: '2.5rem', color: '#f43f5e' }}></i>
           <div style={{ fontWeight: 'bold' }}>Games</div>
        </Link>
